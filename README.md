...
контейнер по прежнему ведет проброс трафика на внутренний 80 порт, но он перестал отвечать. Дальнейная работа невозможна, нет порта который отвечает на веб запросы
